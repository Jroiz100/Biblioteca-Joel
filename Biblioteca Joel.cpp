...
int main()
{
    ...
    std::cout << "Hola! comenzemos con la biblioteca" << std::endl;
    Sleep(1000);
    ...
    for (int i = 0; i < 4; i++) {
        ...
        std::cout << "inserta el  año de publicacion  " << i + 1 << std::endl;
    ...
    for (int i = 0; i < 4; i++) {
        ...
        std::cout << "El año de publicacion del libro " << i + 1 << " es: " << anoPubli[i] << std::endl;
